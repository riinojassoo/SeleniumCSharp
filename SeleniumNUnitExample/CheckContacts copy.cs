...
namespace SeleniumNUnitExample
{
    ...
    public class CheckContacts1
    {
        ...
        public void SearchTest()
        {
            ...
            //change xpath to string
            string contactButtonXPath = "/html/body/div/div/div[4]/div/header/div[2]/div[2]/div/div/section/div[2]/div[1]/div[2]/div/div[2]/nav/ul/li[2]/a/div/span";

            //find element by string
            var contactButton = driver.FindElement(By.XPath(contactButtonXPath));

            //assert that button contains the word contact
            Assert.That(contactButtonXPath.ToLower(), Does.Contain("contact"), "XPath does not contain the word 'contact'.");
            contactButton.Click();
